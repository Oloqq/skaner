...
value =
    nil / false / true / Number / String / '...' / function_ini /
...
functioncall =
    !function (prefix _ call / prefix _ (suffix)* _ call)

// not sure ab this one - changed it bc it led to "variable {}"
//args =
...
illegal_suffix
	= '$' / '_' / '\\' / unop / binop / Ll / Lm / Lo / Lt / Lu / Nl / Nd / Pc / "\u200C" / "\u200D" 
// keywords
keyword = do / end / while / repeat / until / if / then / else / elseif / for / in / local / return / break / nil / false / true / and / or / not
do =  'do' !illegal_suffix { return "keyword do"; }
end =  'end' !illegal_suffix { return "keyword end"; }
while =  'while' !illegal_suffix { return "keyword while"; }
repeat =  'repeat' !illegal_suffix { return "keyword repeat"; }
until =  'until' !illegal_suffix { return "keyword until"; }
if =  'if' !illegal_suffix { return "keyword if"; }
then =  'then' !illegal_suffix { return "keyword then"; }
else =  'else' !illegal_suffix { return "keyword else"; }
elseif =  'elseif' !illegal_suffix { return "keyword elseif"; }
for =  'for' !illegal_suffix { return "keyword for"; }
in =  'in' !illegal_suffix { return "keyword in"; }
local =  'local' !illegal_suffix { return "keyword local"; }
return =  'return' !illegal_suffix { return "keyword return"; }
break =  'break' !illegal_suffix { return "keyword break"; }
nil =  'nil' !illegal_suffix { return "keyword nil"; }
false =  'false' !illegal_suffix { return "keyword false"; }
true =  'true' !illegal_suffix { return "keyword true"; }
and =  'and' !illegal_suffix { return "keyword and"; }
or =  'or' !illegal_suffix { return "keyword or"; }
not =  'not' !illegal_suffix { return "keyword not"; }
function = 'function' !illegal_suffix { return "keyword function"; }

// literals
Name = !keyword [a-zA-Z_]i[a-zA-Z0-9_]i* { return text(); }
Exponent = ('e''-'?[1-9][0-9]*)
Number =
    [0-9]+'.'[0-9]+ Exponent? { return parseFloat(text()) } /
    '0' Exponent? { return parseFloat(text()) }/
    [1-9][0-9]* Exponent? { return parseFloat(text()) }
